        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-linear-to-r from-orange-600 to-red-600 rounded-xl">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-400">+254 796 667-249</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-400">info@cileinternational.com</p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} Cile International Volunteering. All rights reserved.
            </p>
            <div className="flex gap-6 text-sm">
              <a href="privacy.html" className="text-gray-400 hover:text-orange-400 transition-colors duration-300">
                Privacy Policy
              </a>
              <a href="tos.html" className="text-gray-400 hover:text-orange-400 transition-colors duration-300">
                Terms of Service
              </a>
